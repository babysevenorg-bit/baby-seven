      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
          ...
          <div className="max-w-sm">
            <div className="font-display text-lg font-extrabold tracking-widest text-foreground">
              BABY <span className="text-gradient-gold">SEVEN</span>
            </div>
            <p className="mt-3 text-sm text-ash">
              Novelist. Director. Story Architect. Creator of{" "}
              <span className="text-foreground">“Blood Disaster”</span> — the #1 ranked novel.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <button
              ...
              className="mt-2 inline-flex w-fit items-center gap-2 rounded-full bg-gold px-4 py-2 font-display text-xs font-bold tracking-widest text-black dark:text-void transition-transform hover:scale-105"
            >
              <Heart className="h-3.5 w-3.5 fill-black dark:fill-void" />
              BECOME A BACKER
            </button>
          </div>
        </div>
