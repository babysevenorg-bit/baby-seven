...
export function FloatingSupportFAB() {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.96 }}
      className="group fixed bottom-5 right-5 z-40 flex items-center gap-2 rounded-full bg-gradient-to-br from-gold to-amber-600 px-4 py-3 text-void shadow-[0_8px_32px_-4px_rgba(245,176,65,0.6)] sm:bottom-8 sm:right-8"
    >
      <motion.span
        animate={{
          scale: [1, 1.18, 1],
      ...
      >
        <Heart className="h-4 w-4 fill-void text-void" />
      </motion.span>
